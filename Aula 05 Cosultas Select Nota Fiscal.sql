...
-- PODEMOS DEFINOR ALIAS (APELIDOS) PARA AS TABELAS E FACILITAR A CODIFICAÇÃO
...
-- MAX() -> Obtendo o cliente que mais comprou determinado produto em um única nota fiscal
SELECT 
